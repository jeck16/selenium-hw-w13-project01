...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessfully() {
        ...
        */
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Ankur");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Rathod");
        ...
        sendTextToElement(By.id("CardholderName"), "Ankur");
